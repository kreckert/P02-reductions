...
./fourcoltothreecol < ${TESTDIR}/unsolvable-${1}.col | ${TESTDIR}/../bin/check3col 
...
./fourcoltothreecol < ${TESTDIR}/unsolvable-${1}.col | ${TESTDIR}/../bin/${SOLVER} | grep "^SolverSolutionsFound:0"
